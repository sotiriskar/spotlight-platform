...
<aside class="sidebar bg-purple-800 h-screen sticky top-0 z-[1]" style="width: 280px;">
  <h1 class="text-white text-3xl font-bold pt-10 flex items-center justify-center">Spotlight</h1>
